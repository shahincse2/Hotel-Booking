        ...
        btnBook.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                if(db.checkAppointmentExists(username,title+" => "+fullname,address,contact,dateButton.getText().toString(),timeButton.getText().toString())==1){
                    Toast.makeText(getApplicationContext(),"Hotel already booked",Toast.LENGTH_LONG).show();
                }else{
                    ...
                    Toast.makeText(getApplicationContext(),"Your Hotel Booking is done successfully",Toast.LENGTH_LONG).show();
                    startActivity(new Intent(HotelBookActivity.this,HomeActivity.class));
                }
            }
        });
    }
